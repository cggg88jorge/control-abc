	...
	<body>
		...
		<div id="show-site" class="content scaffold-show" role="main">
			...
			<ol class="property-list site">
				...
				<g:if test="${siteInstance?.cr}">
				<li class="fieldcontain">
					<span id="cr-label" class="property-label"><g:message code="site.cr.label" default="Cr" /></span>
					
						<span class="property-value" aria-labelledby="cr-label"><g:fieldValue bean="${siteInstance}" field="cr"/></span>
				...
				<li class="fieldcontain">
					<span id="records-label" class="property-label"><g:message code="site.records.label" default="Records" /></span>
